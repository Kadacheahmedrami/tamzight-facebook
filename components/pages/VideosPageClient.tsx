...
export function VideosPageClient({ initialVideos, totalVideos, currentPage, categories }: VideosPageClientProps) {
  ...
  const fetchVideos = async () => {
    ...
    try {
      ...
      setTotal(data.totalVideos || data.total || 0)
    } catch (error) {
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Discover and share amazing videos</p>
        </div>
      ...
      {totalPages > 1 && (
        <div className="flex justify-center items-center space-x-2 mt-8">
          ...
          <span className="text-sm text-gray-600 dark:text-gray-400">
            Page {page} of {totalPages} ({total} total videos)
          </span>
