...
export default function VideosPage() {
  ...
  const navigationItems = [
    ...
    { href: "/books", icon: Book, label: "كُتب امازيغية متنوعة", description: "مكتبة الكتب الامازيغية" },
    {
      href: "/videos",
      icon: Video,
      label: "فيديوهات امازيغية متنوعة",
      ...
      <div className="lg:hidden bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-lg">فيديوهات امازيغية متنوعة</h1>
              <p className="text-blue-200 text-sm">مقاطع فيديو تعليمية وثقافية</p>
            </div>
          </div>
          <Sheet>
