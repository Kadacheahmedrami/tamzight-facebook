...
// Dummy data for Header component to prevent errors
const DUMMY_STATS = {
  posts: 1247,
  truth: 856,
  questions: 342,
...
const DUMMY_NOTIFICATIONS = [
  {
    id: "notif1",
    type: "like",
    message: "أعجب محمد بمنشورك حول التاريخ الأمازيغي",
  ...
  },
  {
    id: "notif2",
    type: "comment",
    message: "علق سارة على منشورك في حقائق ثابتة حول الأمازيغي",
  ...
  },
  {
    id: "notif4",
    type: "mention",
    message: "ذكرك عمر في منشور حول الثقافة الأمازيغية",
...
const DUMMY_MESSAGES = [
  {
    id: "msg1",
    senderId: "user456",
    sender: "فاطمة الأمازيغية",
    message: "السلام عليكم، أريد أن أسألك عن الكتاب الذي نشرته حول تاريخ الأمازيغ",
  ...
  },
  {
    ...
    senderId: "user789",
    sender: "خالد التازي",
    message: "شكراً لك على المعلومات القيمة حول اللغة الأمازيغية",
  ...
  },
  {
    id: "msg3",
    senderId: "user321",
    sender: "أمينة الريفية",
    message: "هل يمكنك مساعدتي في تعلم كتابة تيفيناغ؟",
